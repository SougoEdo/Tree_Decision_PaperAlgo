...
cd ../report && latexmk -pdf model_and_training_pipeline.tex experiments_planted_threshold.tex experiments_regime_volatility.tex presentation_model_v1.tex presentation_model_v1_short.tex
```
