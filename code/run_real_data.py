...
def load_data():
    ...
    """
    raise NotImplementedError("Fill in load_data() in run_real_data.py with your data.")
...
target_weights = tree.predict_weights(
    X_live, np.asarray(current_weights)[None, :], Sigma_live
)
