...
synthetic_market.py makes a mean-reverting feature x and a price whose drift is
...
until the next one, the way spo_tree.py takes weekly decisions on daily data. The
...
Run:  python planted_threshold_test.py        one case, printed in detail
"""
...
from synthetic_market import ou_process, signal_process
