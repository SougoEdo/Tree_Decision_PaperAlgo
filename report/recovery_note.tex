...
\begin{itemize}\setlength{\itemsep}{1pt}
\item \emph{Quantile candidates}: only the nine deciles of the node's values are screened, and every child keeps at least 10\% of its node;
...
\midrule
deciles & 2 & 2.4 & 98 & 2 & $+0.06\ [-0.02,+0.15]$ & 90\% & -- & 0.76 & 1.00 & 69\% \\
 & 5 & 2.3 & 95 & 5 & $+0.05\ [-0.04,+0.16]$ & 82\% & -- & 0.80 & 0.91 & 84\% \\
 & 10 & 2.2 & 85 & 15 & $+0.04\ [-0.09,+0.19]$ & 74\% & -- & 0.70 & 0.84 & 78\% \\
 & 21 & 2.0 & 70 & 30 & $+0.00\ [-0.17,+0.18]$ & 68\% & -- & 0.50 & 0.74 & 64\% \\
\midrule
deciles + refinement & 2 & 2.2 & 98 & 2 & $+0.07\ [-0.01,+0.12]$ & 92\% & -- & 0.84 & 1.00 & 79\% \\
 & 5 & 2.3 & 95 & 5 & $+0.06\ [-0.04,+0.16]$ & 84\% & -- & 0.79 & 0.91 & 84\% \\
 & 10 & 2.1 & 85 & 15 & $+0.04\ [-0.09,+0.18]$ & 71\% & -- & 0.68 & 0.84 & 78\% \\
 & 21 & 1.9 & 68 & 32 & $-0.02\ [-0.20,+0.20]$ & 59\% & -- & 0.53 & 0.74 & 68\% \\
\midrule
...
\midrule
all three & 2 & 2.0 & 85 & 15 & $+0.06\ [+0.01,+0.14]$ & 88\% & 0.23 & 0.56 & 1.00 & 47\% \\
 & 5 & 2.1 & 92 & 8 & $+0.06\ [-0.04,+0.14]$ & 84\% & 0.22 & 0.78 & 0.91 & 82\% \\
 & 10 & 2.2 & 90 & 10 & $+0.05\ [-0.11,+0.20]$ & 72\% & 0.24 & 0.76 & 0.84 & 83\% \\
 & 21 & 1.9 & 80 & 20 & $+0.03\ [-0.16,+0.21]$ & 69\% & 0.28 & 0.58 & 0.74 & 74\% \\
\bottomrule
\end{tabular}
\caption{The split-search options at edge 0.10, 40 datasets per row ($h$: days between decisions; turnover is in Figure~\ref{fig:enh-maps}). At edge 0.05 no setting improves on the base (gain captured 36--48\% for the base, 30--49\% with deciles, with or without refinement, 24--49\% with all three), and smoothing alone loses most of it (8--23\%).}
\label{tab:enhancements}
\end{table}

\textbf{Reading the figures and the table.}
\begin{itemize}\setlength{\itemsep}{1pt}
\item \textbf{Deciles make the threshold steadier at the slow rates}: the share within $0.25$ of $d$ rises from 63 to 74\% every two weeks and from 45 to 68\% monthly, and the quartile width falls from 0.36 to 0.28 and from 0.48 to 0.35. Weekly and every two weeks the Sharpe ratio is unchanged; at the fastest rate the coarse grid costs 0.11 of Sharpe (0.76 against 0.87), because there the data can pin the threshold finer than a decile.
\item \textbf{The refinement removes that cost} (0.84 at every 2 days, 79\% of the gain against 69\%) and keeps the steadier thresholds. Deciles with refinement match the base everywhere and centre the threshold better at the slow rates: a reasonable default.
