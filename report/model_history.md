...
| E8 | 2026-09-23 (running) | M2, edges 0.05 / 0.10, rates 2/5/10/21 | P4 | smoothing κ = 0.5 and 0.25 (Laplace), κ = 1 (Gaussian); hurdle 2 s.e. below the root; each alone and on top of deciles + refinement | 2240 fits | `experiments_planted_threshold.tex`, Section 12 | (pending) |
