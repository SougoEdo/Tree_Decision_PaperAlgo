...
\item \emph{Three more experiments} follow, one section each: risk aversion, fees and depth (Section~\ref{sec:settings}); quantile candidates, refinement and soft splits (Section~\ref{sec:enhancements}); a calibrated pruning hurdle (Section~\ref{sec:pruning}). Each opens with its own one-paragraph summary.
\end{itemize}}
...
\begin{figure}[H]
\centering\includegraphics[width=0.95\linewidth]{planted_world_one_dataset}
...
\begin{figure}[H]
\centering\includegraphics[width=0.95\linewidth]{learned_vs_ideal_one_dataset}
...
\end{figure}
\begin{figure}[H]
\centering\includegraphics[width=0.95\linewidth]{test_decisions_one_dataset}
...
\begin{figure}[H]
\centering\includegraphics[width=0.92\linewidth]{thresholds_by_rate_histograms}
...
\end{figure}
\begin{figure}[H]
\centering\includegraphics[width=\linewidth]{thresholds_by_rate_boxplots}
...
\begin{figure}[H]
\centering\includegraphics[width=0.95\linewidth]{maps_rate_vs_edge}
...
\end{figure}
\begin{figure}[H]
\centering\includegraphics[width=0.95\linewidth]{maps_rate_vs_speed}
...
\end{itemize}
\begin{figure}[H]
\centering\includegraphics[width=\linewidth]{first_experiment_histograms}
...
\end{figure}
\begin{figure}[H]
\centering\includegraphics[width=\linewidth]{first_experiment_maps}
...
\begin{figure}[H]
\centering\includegraphics[width=0.85\linewidth]{risk_fee_depth_positions}
...
\end{figure}
\begin{figure}[H]
\centering\includegraphics[width=0.95\linewidth]{risk_fee_depth_maps}
...
\begin{figure}[H]
\centering\includegraphics[width=0.9\linewidth]{split_options_scores}
...
\end{figure}
\begin{figure}[H]
\centering\includegraphics[width=0.9\linewidth]{split_options_thresholds}
...
\end{figure}
\begin{figure}[H]
\centering\includegraphics[width=0.95\linewidth]{split_options_maps}
...
\begin{figure}[H]
\centering\includegraphics[width=0.9\linewidth]{pruning_hurdle_splits}
...
\end{figure}
\begin{figure}[H]
\centering\includegraphics[width=0.95\linewidth]{pruning_hurdle_maps}
\caption{Edge 0.10, rows: trading rate, columns: setting. Share of the ideal rule's test gain captured; annualized test Sharpe ratio (ideal rule in brackets); mean number of leaves; turnover per decision (ideal rule in brackets).}
\label{fig:pruning-maps}
\end{figure}
\begin{figure}[H]
\centering\includegraphics[width=0.9\linewidth]{pruning_hurdle_thresholds}
...
\begin{figure}[H]
\centering\includegraphics[width=\linewidth]{resolution_curves}
...
\begin{figure}[H]
\centering\includegraphics[width=0.9\linewidth]{split_options_2_scores}
...
\end{figure}
\begin{figure}[H]
\centering\includegraphics[width=0.9\linewidth]{split_options_2_splits}
\caption{What the trees keep, by setting and trading rate: first split on $x$, no split kept, a second-level split kept (\% of the datasets). \emph{Top:} edge 0.05; \emph{bottom:} edge 0.10.}
\label{fig:options2-splits}
\end{figure}
\begin{figure}[H]
\centering\includegraphics[width=0.95\linewidth]{split_options_2_maps}
\caption{Edge 0.10, rows: trading rate, columns: setting. Share of the ideal rule's test gain captured; annualized test Sharpe ratio (ideal rule in brackets); mean number of leaves; turnover per decision (ideal rule in brackets).}
\label{fig:options2-maps}
\end{figure}
\begin{figure}[H]
\centering\includegraphics[width=0.9\linewidth]{split_options_2_thresholds}
\caption{Weekly decisions: where the first threshold lands, one row per setting; \emph{left:} edge 0.05, \emph{right:} edge 0.10.}
\label{fig:options2-thresholds}
\end{figure}

%% OPTIONS2-RESULTS-START
(filled from the run)
%% OPTIONS2-RESULTS-END
...
\item \code{python -m unittest discover -s tests}: 59 tests, including the alignment and no-look-ahead checks of the rows and the Sharpe-of-cash convention.
