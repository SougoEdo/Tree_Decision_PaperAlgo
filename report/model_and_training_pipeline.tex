...
\item \textbf{A calibrated pruning hurdle}, off by default: the checking-row gain of a split must exceed $k_p$ standard errors (Section~\ref{sec:steps}, step~5); \code{pruning_log} records the standard error of every judged split.
